...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Input Kategori</h6>
                    @if ($errors->any())
                        ...
                        <div class="mb-3">
                          <div class="form-group">
                              <label class="form-label">Nama Kategori</label>
                                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Nama nama kategori" />
                          </div>
                          <div class="form-group">
                ...
                if (response.status == true) {
                    ...
                    for (var key in errorMessages) {
                        if (errorMessages.hasOwnProperty(key)) {
                            errorMessage += errorMessages[key][0] + '<br>';
                        }
                    }
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Gagal ditambahkan!'+ errorMessage,
                    });
                }
            },
            error: function (xhr) {
